...
import { pricingTiers } from "./model/pricingTiers";
import { pricingCategories } from "./model/pricingCategories";
...
export function PricingPage({ onNavigate }: IPricingPageProps) {
      ...
      <div className="px-6 lg:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div
              initial={
                animConfig.shouldAnimate ? { scale: 0.9, opacity: 0 } : {}
              }
          ...
          >
            {pricingCategories.map((category) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl border transition-colors duration-300 ${
            ...
            {filteredTiers.map((tier, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative group rounded-2xl border backdrop-blur-sm transition-colors duration-300 flex flex-col ${
                    tier.popular
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-6 rounded-xl transition-colors duration-300 flex items-center justify-center gap-2 group/btn mt-auto ${
                        tier.popular
